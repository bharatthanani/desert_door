          ...
          <div class="col-12">
             <div class="card">
              <div class="card-header">
                <a href="#!" data-toggle="modal" class="btn btn-primary add"  data-target="#modal-default" >Live Streamed Concerts</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="quickForm1" action="{{route('addLiveStreamedConcerts')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" id="id">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="sub_title" class="form-control" id="sub_title" placeholder="Enter SubTitle">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Ticket Title</label>
                    <input type="text" name="ticket_title" class="form-control" id="ticket_title" placeholder="Enter TicketTitle">
                  </div>
 ...
 var APP_URL = {!! json_encode(url('/')) !!}
  ...
  jQuery(document).delegate('a.delete-record', 'click', function(e) {
    ...
    $(".add").click(function(e){
       ...
       $('.modal-title').text('Add Live Streamed Concerts');
    ...
    $(".edit").click(function(e){
        var id = jQuery(this).attr('data-id');
        $('.modal-title').text('Update Live Streamed Concerts');
        $.ajax({
                type: 'GET', 
                url : "{{route('getliveConcertUpadate')}}", 
                data:{ id: id},
                success : function (data) {
                $("#id").val(data.id);
