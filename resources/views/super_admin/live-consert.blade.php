              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped yajra-datatable">
                  ...
                  <tr id="tbl_posts_body{{$item->id}}">
                    ...
                    <td><img src='{{asset("documents/slider/$item->image")}}' alt="" width="100"></td>
                    <td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="quickForm1" action="{{route('AddLiveConcert')}}" method="POST" enctype="multipart/form-data">
                @csrf
 ...
 var APP_URL = {!! json_encode(url('/')) !!}
  ...
  jQuery(document).delegate('a.delete-record', 'click', function(e) {
    ...
    $(".add").click(function(e){
       ...
       $('.modal-title').text('Add Live Concerts');
    ...
    $(".edit").click(function(e){
        var id = jQuery(this).attr('data-id');
        $('.modal-title').text('Update Live Concerts');
        $.ajax({
                type: 'GET', 
                url : "{{route('LiveConcertgetUpdate')}}", 
                data:{ id: id},
                success : function (data) {
                $("#id").val(data.id);
