          ...
          <div class="col-12">
             <div class="card">
              <div class="card-header">
                <a href="#!" data-toggle="modal" class="btn btn-primary add"  data-target="#modal-default" >Add Slider</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped yajra-datatable">
                  ...
                  <tr id="tbl_posts_body{{$item->id}}">
                    ...
                    <td width="10%"><img class="profile-user-img img-fluid" src='{{asset("documents/slider/$item->image")}}' alt="User profile picture"></td>
                    <td width="20%">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="quickForm1" action="{{route('Addslider')}}" method="POST" enctype="multipart/form-data">
                @csrf
    ...
    $(".edit").click(function(e){
        ...
        $.ajax({
               ...
               $("#description").val(data.description);
                ...
                $("#output").attr("src",APP_URL+"/public/documents/slider/"+data.image);
